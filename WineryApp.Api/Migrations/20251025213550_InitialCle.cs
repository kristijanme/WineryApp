...
{
    /// <inheritdoc />
    public partial class InitialCle : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Wines",
                columns: new[] { "Id", "Name", "Price", "StockQuantity", "Type", "Winery", "Year" },
                values: new object[,]
                {
                    { 1, "Merlot", 149.99m, 50, "Red", "Tikves", 2020 },
                    { 2, "Chardonnay", 129.99m, 40, "White", "Bovin", 2021 }
                });
